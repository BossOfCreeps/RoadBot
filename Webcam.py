...
#    global IN1, IN2, IN3, IN4, IN5. IN6, IN7, IN8
    if (abs(229 - frame[20,400,2])<maxi) and (abs(frame[20,400,1]-147)<maxi) and (abs(frame[20,400,0]-128)<maxi):
        f=True
    if (abs(229 - frame[60,400,2])<maxi) and (abs(frame[60,400,1]-147)<maxi) and (abs(frame[60,400,0]-128)<maxi):
        s=True
